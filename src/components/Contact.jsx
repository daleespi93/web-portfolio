    ...
    <div id="Contact" className="flex min-h-screen w-full flex-col items-center justify-center gap-16 p-8">
      ...
      <form className="flex w-full max-w-md flex-col gap-8 rounded-lg p-6 md:max-w-lg lg:max-w-xl">
        ...
        <div className="flex flex-col gap-4">
          ...
          <button className="rounded-lg border-2 border-[#5B96D2] bg-[#3780C8] px-6 py-3 font-semibold text-white transition-all duration-200 hover:bg-[#2D69A4] dark:bg-zinc-500 dark:hover:bg-zinc-800 dark:border-zinc-200">Send Message</button>
      </form>
