        ...
        <div>
            <div className='max-w-3xl'>
                ...
                <div className="relative space-y-1 border-l-2 p-8 text-left">
                    <h3 className='text-xl font-semibold md:text-2xl'>Z Suds Laundromat</h3>
                    <p className='font-light text-lg text-gray-600'>Operations Manager</p>
                    <p className='text-sm text-gray-600'>I managed daily operations and staff to make sure everything ran smoothly and customers stayed happy. 
